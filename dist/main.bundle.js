    ...
    CoreModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__books_resolver_service__["a" /* BookResolverService */],
...
var DataService = (function () {
    function DataService(loggerService, httpClient) {
    ...
    DataService.prototype.getReaderById = function (id) {
        return this.httpClient.get("/api/readers/" + id, {
    ...
    DataService.prototype.addReader = function (newReader) {
        return this.httpClient.post('/api/readers/', newReader, {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
    ...
    DataService.prototype.updateReader = function (updatedReader) {
        return this.httpClient.put("/api/readers/" + updatedReader.readerID, updatedReader, {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Content-Type': 'application/json'
            })
        });
    ...
    DataService.prototype.deleteReader = function (readerID) {
        return this.httpClient.delete("/api/readers/" + readerID);
    };
    ...
    DataService.prototype.getBookById = function (id) {
        return this.httpClient.get("/api/books/" + id, {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Accept': 'application/json',
                'Authorization': 'my-token'
            })
    ...
    DataService.prototype.addBook = function (newBook) {
        return this.httpClient.post('/api/books', newBook, {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Content-Type': 'application/json',
            })
        });
    ...
    DataService.prototype.updateBook = function (updatedBook) {
        return this.httpClient.put("/api/books/" + updatedBook.bookID, updatedBook, {
            headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Content-Type': 'application/json',
            })
        });
...
var EditBookComponent = (function () {
    ...
    EditBookComponent.prototype.saveChanges = function () {
        ...
        this.dataService.updateBook(this.selectedBook)
            .subscribe(function (data) { return console.log("Book " + _this.selectedBook.title + " has sucessfully been updated"); }, function (err) { return console.log(err); });
    };
...
var EditReaderComponent = (function () {
    ...
    EditReaderComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getReaderById(readerID)
            ...
            _this.currentBadge = _this.badgeService.getReaderBadge(data.totalMinutesRead);
        }, function (err) { return console.log(err); });
    };
    EditReaderComponent.prototype.saveChanges = function () {
        var _this = this;
        this.dataService.updateReader(this.selectedReader)
            .subscribe(function (data) { return console.log("Reader " + _this.selectedReader.name + " has sucessfully been updated"); }, function (err) { return console.log(err); });
    };
