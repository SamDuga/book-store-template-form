...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (resolvedData instanceof BookTrackerError) console.log(`Dashboard component error: ${resolvedData.friendlyMessage}`);
    else this.allBooks = resolvedData;
    ...
    this.dataService.getAllReaders()
      .subscribe(
        ...
        //() => console.log('Retrived all readers')
      );
